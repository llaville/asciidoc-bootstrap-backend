...
NOTE: The Asciidoc bootstrap backend standard version (2.0.0) included
the latest compiled version of bootstrap 2 (2.3.2).

CAUTION: The Asciidoc bootstrap backend next version (3.0.0) will include and support
the latest compiled version of bootstrap 3 (3.0.0).
