...
The following example will include the standard href link
in the HTML output file:

  $ asciidoc -a totop=text -b bootstrap mydoc.txt

The following example will include a dynamic clickable area
in the HTML output file:

  $ asciidoc -a totop=ui -b bootstrap mydoc.txt
...
The following example will include a dynamic versions list, located in the navinfo.html,
in the HTML output file:

  $ asciidoc -a brandver -b bootstrap mydoc.txt

The following example will remove a dynamic versions list, located in the navinfo.html,
and won't be shown in the final HTML output file (defautl behavior):
