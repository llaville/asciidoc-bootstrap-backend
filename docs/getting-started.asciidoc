...
* version 2.3.2 ( +themes/2+ ) and 3.0.2 ( +themes/3+ ) of the default theme from http://bootswatch.com/[Bootswatch] template provider.
* version 2.3.2 ( +bootstrap/2+ ) and 3.0.2 ( +bootstrap/3+ ) of Bootstrap.
...
.For Bootstrap 3
* http://laurent-laville.org/asciidoc/bootstrap/flatly-theme3-3.0.0.zip[]
* http://laurent-laville.org/asciidoc/bootstrap/readable-theme3-3.0.0.zip[]
* http://laurent-laville.org/asciidoc/bootstrap/cerulean-theme3-3.0.0.zip[]

.For Bootstrap 2
* http://laurent-laville.org/asciidoc/bootstrap/flatly-theme2-3.0.0.zip[]
* http://laurent-laville.org/asciidoc/bootstrap/readable-theme2-3.0.0.zip[]
* http://laurent-laville.org/asciidoc/bootstrap/cerulean-theme2-3.0.0.zip[]
...
| icons        | Choose representation of icon: png `image` or `font`.
