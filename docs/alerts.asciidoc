...
:doctitle:    Bootstrap Alert Component for Asciidoc-Bootstrap - {title}
...
.Behind the scene
************************************************
Build this `{docfile}` footnote:[https://raw.githubusercontent.com/llaville/asciidoc-bootstrap-backend/v4/docs/alerts.asciidoc]
