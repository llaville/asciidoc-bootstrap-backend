...
link:panels.cerulean.html[Learn more] how AsciiDoc-Bootstrap backend implements this feature.
...
link:alerts.cerulean.html[Learn more] how AsciiDoc-Bootstrap backend implements this feature.

footnote:[{rawbaseurl}/docs/delimited-blocks.asciidoc].
